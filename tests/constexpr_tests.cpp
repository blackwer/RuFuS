...
void test_template_jit(bool check_even) {
  std::string func_str = check_even ? "bool is_even_or_odd_template<true>(int)" : "bool is_even_or_odd_template<false>(int)";
  using FuncType = bool (*)(int);
...
void test_constexpr_jit(bool check_even) {
  std::string func_str = check_even ? "bool is_even_or_odd_constexpr<true>(int)" : "bool is_even_or_odd_constexpr<false>(int)";
  using FuncType = bool (*)(int);
